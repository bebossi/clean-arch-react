  ...
  return (
    ...
    <div className="flex flex-col justify-between min-h-[100vh] bg-gray-300 ">
      ...
      <div className="flex flex-col self-center w-full max-w-[800px] flex-grow p-[40px] mb-[24px]  ">
        ...
        <ul className="flex flex-col sm:flex-row flex-wrap justify-between h-full ">
          <li className="h-[250px]  bg-white flex flex-col justify-between rounded-lg  sm:basis-[48%] mb-[24px] shadow-md  ">
            ...
            <div className="flex flex-row relative  rounded-t-md justify-between flex-grow bg-no-repeat bg-gradient-to-r from-rose-500 to-rose-500 linear-gradient ">
              ...
              <p className="text-[18px] m-[24px] self-center flex-grow ">
          ...
          <li className="h-[250px] bg-white flex flex-col justify-between rounded-lg  sm:basis-[48%] mb-[24px] shadow-md skeleton"></li>
          <li className="h-[250px] bg-white flex flex-col justify-between rounded-lg  sm:basis-[48%] mb-[24px] shadow-md skeleton"></li>
          <li className="h-[250px] bg-white flex flex-col justify-between rounded-lg  sm:basis-[48%] mb-[24px] shadow-md skeleton"></li>
          <li className="h-[250px] bg-white flex flex-col justify-between rounded-lg  sm:basis-[48%] mb-[24px] shadow-md skeleton"></li>
        </ul>
